...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
		...
		<script type="text/javascript" src="resources/js/registro.js">   </script>
			...
			<div class="col-md-6 col-md-offset-3">
				<div class="panel panel-login">
					<div class="panel-heading">
						<div class="row">
							<div class="col-xs-6">
								<a id="login-form-link" href="<%=request.getContextPath() %>/">Login</a>
							</div>
							<div class="col-xs-6">
								<a class="active" id="register-form-link" href="<%=request.getContextPath() %>/registrarUsuario">Registro</a>
							</div>
						</div>
						<hr>
					</div>
