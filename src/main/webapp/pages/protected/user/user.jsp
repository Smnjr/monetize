	...
	<form id="user_edit_form" >
		<div class="row">
			<div class="col-lg-12">
				...
				<h1 class="page-header">Perfil de usu�rio</h1>
			</div>
		</div>
		<div class="row">
			<div class="col-lg-10">
				<div class="panel panel-default">
					<div class="panel-heading">Informa��es do usu�rio:</div>
								...
								<input type="hidden" id="id" name ="id" value="${usuario.id}"/>
									...
									<div class="form-group" id="userFormGroup">
										<input type="text" name="username" tabindex="1" id="user"
											...
											placeholder="Login do usu�rio" class="form-control"
											minlength="5" maxlength="20" required />

									</div>
									<div class="form-group" id="userNameFormGroup">
										<input type="text" name="nome" tabindex="1" id="name"
											autocomplete="off" placeholder="Nome do usu�rio"
									...
									<div class="form-group">
										<input type="password" name="confirmacaoSenha"
											...
											placeholder="Confirma��o de senha" minlength="5"
											maxlength="20" required />
									</div>
